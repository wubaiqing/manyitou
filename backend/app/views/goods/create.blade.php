...
<script type="text/javascript">
	$(document).ready(function () {
		...
		var ue = UE.getEditor('price_text');
...
@section('content')
	...
	{{ Form::open(array('url' => 'goods/create', 'method' => 'post', 'class' => 'form-horizontal')) }}
		...
		<div class="control-group">
			...
			<div class="controls">
				{{ Form::textArea('rules', Input::old('rules'), ['class' => 'span5', 'rows' => '3']) }}
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">平台描述（首页）</label>
			<div class="controls">
				{{ Form::textArea('playform_sort_desc', Input::old('playform_sort_desc'), ['class' => 'span5', 'rows' => '3']) }}
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">平台描述（详情）</label>
			<div class="controls">
				{{ Form::textArea('playform_desc', Input::old('playform_desc'), ['class' => 'span5', 'rows' => '3']) }}
			</div>
		</div>

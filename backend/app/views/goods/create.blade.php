...
@section('content')
    ...
    {{ Form::open(array('url' => 'goods/create', 'method' => 'post', 'class' => 'form-horizontal')) }}
        ...
        <div class="control-group">
            ...
            <div class="controls">
                {{ Form::textArea('playform_sort_desc', Input::old('playform_sort_desc'), ['class' => 'span5', 'rows' => '4', 'id' => 'playform_sort_desc', 'style' => 'height:220px; width:600px;']) }}
            </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                {{ Form::textArea('rules', Input::old('rules'), ['class' => 'span5', 'rows' => '3', 'id' => 'rules', 'style' => 'height:220px; width:600px;']) }}
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                {{ Form::textArea('price_text', null, ['class' => 'span5', 'rows' => '3 ', 'id' => 'price_text', 'style' => 'height:220px; width:600px;']) }}
            </div>
        </div>
        <div class="control-group">

<div class="wn_right_xf">
    ...
    <div class="wn_xf_c">
        ...
        <a class="wn_c_a" target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=2328628221&amp;site=qq&amp;menu=yes" rel="nofollow">
            <img border="0" align="absmiddle" alt="点这里给我发消息" src="http://myt.oss-cn-hangzhou.aliyuncs.com/static/qq/qq.png">
            <span>客服3</span>
        </a>
        <div class="wn_c_div">
    ...
    <!--<div class="wn_r_c"></div>-->
    <a class="wn_kefu_sj" ref="nofollow" target="_blank" href="http://www.manyitou.com/billboard/detail/2.html">站长入驻</a>
    <a class="wn_fanhui" href="javascript:void(0);" onclick="window.scrollTo(0,0);"></a>
</div>
